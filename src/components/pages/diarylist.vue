<template>
  <div class="diarylist">
    <div class="diarylist__wrapper col-lg-8 col-lg-offset-2 col-xs-12">
      <div class="diary__title">游记</div>
      <div class="diarylist">
        <div class="diarylist_i" v-for="diary in diarys"  v-bind:key="diary.diaryId">
          <div class="diary_iTitle" v-text="diary.title"></div>
          <div class="diary_iContent col-xs-12 col-lg-10" v-text="diary.content"></div>
          <div class="diary_iImg col-xs-12 col-lg-2"><img :src="diary.imgSrc"></div>
...
@import "../../assets/scss/pages/diarylist.scss";
</style>
<script>
export default {
  name:'diarylist',
